...
App({
  ...
  _returnListHeight:function(isshow){
    if (!isshow) {
      return this.getSystemInfoData().windowHeight - 41;
    } else {
      return this.getSystemInfoData().windowHeight - 136;
    }
  },
  ...
  startPlayVideo: function(event) {
    ...
    video.play();
    newdata[compid + '.videoPosterHidden'] = true;
    pageInstance.setData(newdata);
  ...
  globalData:{
    ...
    appTitle: '资源大师',
    appDescription: '学习',
    appLogo: 'http://img.weiye.me/zcimgdir/thumb/t_15137530685a3a09ec7e1d5.jpg'
  }
})
